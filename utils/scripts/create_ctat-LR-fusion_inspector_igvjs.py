...
arguments.add_argument("--file_prefix",
                       ...
                       required=True,
                       type=str,
                       help="prefix to FusionInspector output files. Do not change? Identifies trinity related files")
                       
arguments.add_argument("--sample_prefix",
                       dest = "sample_prefix",
                       required=True,
                       type=str,
                       help="prefix to sample FusionInspector files. _ctat-LR-fusion.fusion_predictions.abridged.tsv file in the defined FI_directory")
...
fusions_table = os.path.join( absolute_fusion_directory, f"{sample_prefix}_ctat-LR-fusion.fusion_predictions.abridged.tsv") 
